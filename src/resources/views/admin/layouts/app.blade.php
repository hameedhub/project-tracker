...
<div class="nav-scroller bg-white shadow-sm">
  ...
  <a class="nav-link {{ Request::is('admin/users') ? 'active' : '' }}" href="{{ route('users.index')}}"> Users </a>
  <a class="nav-link {{ Request::is('admin/set') ? 'active' : '' }}" href="{{ route('set.index')}}"> Class </a>
  <a class="nav-link {{ Request::is('admin/courses') ? 'active' : '' }}" href="{{ route('courses.index')}}"> Course</a>
  <a class="nav-link {{ Request::is('admin/grades') ? 'active' : '' }}" href="{{ route('grades.index')}}">Grade</a>
  </nav>
</div>

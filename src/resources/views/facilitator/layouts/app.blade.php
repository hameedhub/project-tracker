...
<div class="nav-scroller bg-white shadow-sm">
  ...
  <a class="nav-link {{ Request::is('facilitator/course') ? 'active' : '' }}" href="{{ route('course.index') }}"> Course</a>
    <a class="nav-link {{ Request::is('facilitator/evaluation') ? 'active' : '' }}" href="{{ route('evaluation.index')}}">Assessment</a>
  <a class="nav-link {{ Request::is('facilitator/submitted') ? 'active' : '' }}" href="{{ route('submitted.index') }}">Submission</a>
  <a class="nav-link {{ Request::is('facilitator/material') ? 'active' : '' }}" href="{{ route('material.index')}}">Materials</a>
...
<main role="main" class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
      <img class="mr-3" src="{{asset('/icon.png')}}" width="100" height="48">
        <div class="lh-100">
